...
# /home/flin2/miniconda3/envs/uniad2.0/lib/python3.9/site-packages/nuscenes/eval/tracking/evaluate.py for single city test
...
# REPLACE WITH:
        ...
        # <<< MOD: filter both pred & gt to only samples in target city
        ...
        for token in gt_boxes.sample_tokens:
            ...
            if log['location'].startswith(target_city):
                valid_tokens.append(token)

        # from nuscenes.eval.tracking.utils import filter_by_sample_token
        pred_boxes = filter_by_sample_token(pred_boxes, valid_sample_tokens=valid_tokens)
        gt_boxes = filter_by_sample_token(gt_boxes, valid_sample_tokens=valid_tokens)
###############
